...
const { Permiso, Permiso_rol } = require('../models/init-models');
...
exports.saveItem = async (objeto) => {
    try {
        ...
        const permiso_rol = new Permiso_rol(objeto);

        // Guardar en BD
        await permiso_rol.save();

        return success(permiso_rol, successMessages.SUCCESS_ADD);
    } catch (e) {
