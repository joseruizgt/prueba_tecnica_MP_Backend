...
const { getList, getItem, saveItem, editItem, deleteItem, getListFiscalia } = require('../services/fiscalia.service');


exports.getListFiscalia = async (req = request, res = response) => {
  try {
    const result = await getListFiscalia(req.query);
